...
> 全龄订阅制学习平台 · P1 MVP · 基于《潮汐学习产品计划书 v0.3（Agent 执行版）》实现

用户按月订阅，解锁**持续更新**的体系化课程，并通过**需求投票**决定平台下一批课程。
学习、笔记、复习与上新提醒形成长期留存闭环。

```
试学 → 订阅 → 学习 → 记笔记 → 投票 → 上新提醒   ——  P1 要跑通的核心闭环
```
...
| 账号 | 密码 | 说明 |
|---|---|---|
| `demo@tide.learning` | `demo123` | 已订阅年度会员，可体验完整学习/投票 |
| `admin@tide.learning` | `admin123` | 后台管理员，可进入 `/admin` |

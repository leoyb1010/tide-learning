...
import { Users, PlayCircle } from "@phosphor-icons/react/dist/ssr";
  ...
  return (
    <Spotlight className="h-full rounded-[var(--radius-card)]">
      <Link
        ...
        className="flex h-full flex-col overflow-hidden rounded-[var(--radius-card)] border border-ink-100 bg-paper-raised transition-all duration-300 [transition-timing-function:var(--ease-out-expo)] hover:-translate-y-1 hover:border-accent-200 hover:shadow-[0_24px_48px_-24px_rgba(13,51,45,0.25)]"
      >
        ...
        <div className="flex flex-1 flex-col p-5">
          ...
          <div className="mt-auto flex items-center justify-between border-t border-ink-100 pt-3.5 text-[0.78rem]">
            <span className="text-accent-700">{course.updateText}</span>

...
export function GenNavIndicator() {
  ...
  return (
    <Link
      ...
      title={title}
      aria-label={title}
      className="studio-lift hidden items-center gap-1.5 rounded-full border border-[var(--red-soft-border)] bg-[var(--red-soft)] py-1.5 pl-2 pr-2.5 text-[12.5px] shadow-[var(--card)] transition-colors hover:brightness-[0.98] sm:flex"
    >
      <span
